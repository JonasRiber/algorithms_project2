...
def parse_arguments():
    ...
    parser.add_argument("-m", "--matrix", type=str, help="Path to scoring matrix file in Phylip-like format")
    parser.add_argument("-g", "--gap", type=int, default=-2, help="Gap penalty")
    parser.add_argument("-o", "--opening", type=int, default=-5, help="Gap opening penalty")
...
def main():
    ...
    write_alignment_to_fasta(aligned_sequences, "aligned_sequences.fasta")
